                ...
                while (true) {
                    ...
                    switch (in) {
                        ...
                        case 2:
                            ...
                            manager.addBook(scanner.next(), manager.getAuthor(scanner.next(), scanner.next(), scanner.nextInt()), scanner.next(), scanner.next());
                    ...
                    if (manager.checkCustomer(customer) != null) {
                        ...
                        switch (in) {
                            case 1:
                                System.out.println("Enter book details and author details");
                                Book brwBook = manager.borrowBook(new Book(scanner.next(), scanner.next(), scanner.next()), new Author(scanner.next(), scanner.next(), scanner.nextInt()));
                                try {
                            ...
                            case 2:
                                System.out.println("Enter book details and author details");
                                Book rtrnBook = manager.returnBook(new Book(scanner.next(), scanner.next(), scanner.next()), new Author(scanner.next(), scanner.next(), scanner.nextInt()));
                                try {
